...
vector<keg> Gaming_field::revert_kegs(int x, int y, Cell_state keg_type) {
...
bool Gaming_field::find_up_same_color(int x, int y, Cell_state keg_type, int* x_1, int* y_1) {
	for (int i = y - 1; i > 0; i--) {
...
bool Gaming_field::find_down_same_color(int x, int y, Cell_state keg_type, int* x_1, int* y_1) {
...
bool Gaming_field::find_right_same_color(int x, int y, Cell_state keg_type, int* x_1, int* y_1) {
...
bool Gaming_field::find_left_same_color(int x, int y, Cell_state keg_type, int* x_1, int* y_1) {
	for (int i = x - 1; i > 0; i--) {
		if (field[y - 1][i - 1] == Empty)
			return false;
		if (field[y - 1][i - 1] == keg_type) {
...
bool Gaming_field::find_up_right_same_color(int x, int y, Cell_state keg_type, int* x_1, int* y_1) {
...
bool Gaming_field::find_up_left_same_color(int x, int y, Cell_state keg_type, int* x_1, int* y_1) {
...
bool Gaming_field::find_down_right_same_color(int x, int y, Cell_state keg_type, int* x_1, int* y_1) {
...
bool Gaming_field::find_down_left_same_color(int x, int y, Cell_state keg_type, int* x_1, int* y_1) {
